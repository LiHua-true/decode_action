//Sat May 17 2025 11:52:40 GMT+0000 (Coordinated Universal Time)
...
async function _0x3b2a2e() {
  try {
    ...
    return console.log("代理请求成功:", _0xf3ea1f.data.origin), true;
  } catch (_0x5855fe) {
    return console.error("代理请求失败:", _0x5855fe.message), false;
  }
}
...
async function _0x584754(_0x589aec, _0x13db39) {
  ...
  try {
    ...
    if (_0x157c8b) return parseInt(_0x157c8b[1], 10);else {
      return console.warn("[账号 " + _0x13db39 + "] 未找到积分信息"), null;
    }
  } catch (_0x467af5) {
    return console.error("[账号 " + _0x13db39 + "] 获取积分失败: " + _0x467af5), null;
  }
}
...
async function _0x2cbd63(_0x4e298b) {
  ...
  try {
    ...
    return console.error("获取 Token 失败: " + _0x1d4fdd), null;
  }
}
...
async function _0x2f6334(_0x2b6ab7) {
  ...
  try {
    ...
    return console.error("获取搜索任务进度失败，错误: " + _0x20dd0c), null;
  }
}
async function _0x22d984(_0x582b5b, _0x453425, _0x3969a7) {
  ...
  for (const _0x707044 of _0x5e1922) {
    ...
    const _0x688327 = Math.floor(Math.random() * (300 - 250 + 1)) + 250;
  ...
  for (const _0x7fe29c of _0xe7a971.dashboard.morePromotions) {
    ...
    const _0x2b4720 = Math.floor(Math.random() * (300 - 250 + 1)) + 250;
  ...
  return _0x251dcf += "账号 " + _0x582b5b + " 剩余积分 " + _0x2c4e58 + "\n", _0x251dcf;
}
async function _0x4b9850(_0x3bb642, _0x29a493, _0x1d9b34, _0x3be108, _0xbe05ff) {
  ...
  while (true) {
    ...
    if (_0x1cd9b7 >= _0xf62931) {
      ...
      const _0x57f7df = Math.floor(Math.random() * (300 - 250 + 1)) + 200;
      console.log("[账号 " + _0x3bb642 + "] 等待 " + _0x57f7df + " 秒");
      await new Promise(_0x523dcf => setTimeout(_0x523dcf, _0x57f7df * 1000));
      break;
    }
    const _0xdfa934 = Math.floor(Math.random() * (300 - 250 + 1)) + 200;
  ...
  while (true) {
    ...
    const _0x1c5dbf = Math.floor(Math.random() * (300 - 250 + 1)) + 200;
...
const _0x2655fa = async (_0x57e6a3, _0x71c5be) => {
    ...
    try {
      ...
      if (_0x3b7c00.response && _0x3b7c00.response.balance !== undefined) {
        ...
        return console.log("app账号 " + _0x57e6a3 + " 签到成功 当前余额: " + _0xa72857), _0x49f1b8 += "app账号 " + _0x57e6a3 + " 签到成功 当前余额: " + _0xa72857 + "\n", _0x49f1b8;
...
async function _0x475b85(_0x26fdd3) {
  ...
  try {
    ...
    return console.error("请求失败:", _0x41a097), {
      "max": 1,
      "progress": 0
    };
  }
...
async function _0x3d90c7(_0x3fd35b, _0x3f8e4c) {
  ...
  for (let _0x4a9b91 = 0; _0x4a9b91 < 15; _0x4a9b91++) {
    ...
    try {
      ...
      const _0x49efe6 = Math.floor(Math.random() * (300 - 250 + 1)) + 250;
  ...
  return console.log("[app账号 " + _0x3fd35b + "] 阅读任务完成 当前进度: " + _0x4655c5.progress + "/" + _0x4655c5.max), _0x218c57 += "app账号 " + _0x3fd35b + " 阅读任务完成 当前进度: " + _0x4655c5.progress + "/" + _0x4655c5.max + "\n", _0x218c57;
}
const _0x5e6718 = "1.4";
async function _0x4e8d9f() {
  ...
  try {
    ...
    if (_0x51f2aa.status === 200) {
      ...
      return console.log("请求失败，状态码: " + _0x51f2aa.status), null;
    }
  } catch (_0x1e32b9) {
    return console.error("请求发生错误:", _0x1e32b9.message), null;
  }
}
  ...
  try {
    ...
    if (_0x87e262.code === 200 && _0x87e262.data && _0x87e262.data.length > 0) {
      ...
      const _0x2df0ee = _0x87e262.data[0].md5_hash,
        _0x17df31 = _0x17c1b7();
      if (!_0x17df31) {
        return console.log("无法获取本地 MAC 地址，任务停止。"), false;
      }
      console.log("当前MAC地址:", _0x17df31);
      if (_0xe8e6a5) {
        if (_0xe8e6a5 === _0x17df31) return true;else {
          return console.log("当前设备不匹配，任务停止。"), false;
        }
      } else {
